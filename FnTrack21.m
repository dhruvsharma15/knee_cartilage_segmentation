function [Cw Bw3 hslOp1 hslOp2 hslOp3 hslOp4 hslOp5] = FnTrack21(IG,Vs,dilateEdge,flag)
...
%%%%%%%%%%%angle 0 degree%%%%%%%%%%%%%%%%%%
lineln=3;
se = strel('line',lineln, 0);
hslOp1 = imopen(Bw2, se);

%%%%%%%%%%%angle 30 degree%%%%%%%%%%%%%%%%%%
se = strel('line',lineln, 30);
hslOp2 = imopen(Bw2, se);

%%%%%%%%%%%angle 60 degree%%%%%%%%%%%%%%%%%%
se = strel('line',lineln, 60);
hslOp3 = imopen(Bw2, se);

%%%%%%%%%%%angle 120 degree%%%%%%%%%%%%%%%%%%
se = strel('line',lineln, 120);
hslOp4 = imopen(Bw2, se);

%%%%%%%%%%%angle 150 degree%%%%%%%%%%%%%%%%%%
se = strel('line',lineln, 150);
