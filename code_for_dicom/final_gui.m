...
% Last Modified by GUIDE v2.5 04-Jul-2016 01:53:49
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.GTmarking,'Visible','on')
set(handles.start_page,'Visible','off')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.start_page,'Visible','on')
set(handles.GTmarking,'Visible','off')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.segmentProcess,'Visible','on')
set(handles.GTmarking,'Visible','off')
...
% handles    structure with handles and user data (see GUIDATA)
set(handles.GTmarking,'Visible','on')
set(handles.segmentProcess,'Visible','off')


% --- Executes on button press in calcMetric.
function calcMetric_Callback(hObject, eventdata, handles)
% hObject    handle to calcMetric (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
